...
def extract(file_path):
    ...
    output_rotate = "./image_rotate.jpg"
    output_rotate_x0 = "./image_rotate_x0.jpg"
    output_path_aws = "./output/ketqua.txt"
    output_number_list = "./numbers.txt"
...
# Hàm xử lý chuỗi và trả về full kết quả
...
# Hàm xử lý dự đoán và trả về full kết quả
def predict(file_path):
    ...
    texts, probs = ocr_model.predict_folder([os.path.join(f"./results/{img_id}/crops", i) for i in img_paths], return_probs=True)
...
def du_doan_txt(file_path):
    ...
    output_path_correction = "./results/output_ok.txt"
    ...
    return output_path_correction


# # Upload ảnh tên giống tên ảnh
# @app.post("/upload")
...
# # Trích xuất thông tin, trả về thông tin thửa đất
# @app.post("/thuadat")
# async def upload_image(request: Request, file: UploadFile = File(...)):
#     # Lưu file ảnh tải lên từ phía người dùng
#     if not allowed_file(file.filename):
...
#     # Return the results as a JSON response
#     return {"Thửa đất": results}

# Trích xuất thông tin, trả về thông tin thửa đất
# @app.get("/thuadat")
# async def thuadat():
#     file_path = r"./static/uploads/sodo.jpg"
#     results = extract(file_path)
    
#     # Return the results as a JSON response
#     return {"Thửa đất": results}

# # Trích xuất thông tin, trả về full kết quả
# @app.post("/diachi")
# async def upload_image(request: Request, file: UploadFile = File(...)):
#     # Lưu file ảnh tải lên từ phía người dùng
#     if not allowed_file(file.filename):
...
# @app.get("/hinhthucsudung")
# async def hinhthucsudung():
#     hinhthucsudung = None
#     return {"Hình thức sử dụng": hinhthucsudung}

# @app.get("/mucdichsudung")
# async def mucdichsudung():
#     mucdichsudung = None
#     return {"Mục đích sử dụng": mucdichsudung}

# @app.get("/thoihansudung")
# async def thoihansudung():
#     thoihansudung = None
#     return {"Thời hạn sử dụng": thoihansudung}

# @app.get("/nguongocsudung")
# async def nguongocsudung():
#     nguongocsudung = None
#     return {"Nguồn gốc sử dụng": nguongocsudung}
...
# @app.get("/congtrinhxaydungkhac")
# async def congtrinhxaydungkhac():
#     congtrinhxaydungkhac = None
#     return {"3. Công trình xây dựng khác": congtrinhxaydungkhac}

# @app.get("/rungsanxuat")
# async def rungsanxuat():
#     rungsanxuat = None
#     return {"4. Rừng sản xuất là rừng trồng": rungsanxuat}

# @app.get("/caylaunam")
# async def caylaunam():
#     caylaunam = None
#     return {"5. Cây lâu năm": caylaunam}

# @app.get("/ghichu")
# async def ghichu():
#     ghichu = None
#     return {"6. Ghi chú": ghichu}
